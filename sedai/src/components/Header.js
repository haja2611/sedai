...
function Header() {
  ...
  // const SearchItems = [
  //   {
  //     Name: <Typography className="a1">Platform #8964;</Typography>,
  //     Link: "#",
  //   },
  //   {
  //     Name: (
  //       <Typography className="about">
  //         Solutions <KeyboardArrowDownIcon sx={{}} />
  ...
  //                 jerald
  //                 <ArrowForwardIosIcon
  //                   sx={{ fontSize: "small", float: "right", marginTop: "4px" }}
  //                 />
  //               </a>
  //               <div className="submenu2">
  //                 <ul>
  //                   <li>
  //                     <a href="football">Footbal</a>
  //                   </li>
  //                   <li>
